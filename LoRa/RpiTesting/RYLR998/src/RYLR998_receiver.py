...
def callback(message):
    ...
    if message: 
        ...
        mqtt_send(mqttClient, "RYLR998", f"LoRa message received: {message}")
        print("LoRa message received: ", message)
    else: 
        return 


# Initial port and buffer settings
settings = {
...
# Set up MQTT object
mqttClient = Mqtt.MQTTClient(client_id="REYAX998Device2", on_connect=on_connect_callback, 
...
# Setting initial configuration settings
configuration = {
